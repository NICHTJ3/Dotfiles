return {
  ...
  },
  {
    ...
    -- stylua: ignore
    keys={
      { '<leader>sf', function() Snacks.picker.smart() end, desc = 'Snacks picker [S]earch [F]iles', },
      { '<leader><space>', function() Snacks.picker.smart() end, desc = 'Snacks picker Search Files', },
