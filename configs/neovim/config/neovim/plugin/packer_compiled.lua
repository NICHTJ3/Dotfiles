...
_G.packer_plugins = {
  ...
  ["nvim-luapad"] = {
    loaded = true,
    path = "/Users/trent.nicholson/.local/share/nvim/site/pack/packer/start/nvim-luapad",
