...
_G.packer_plugins = {
  ...
  ["gitsigns.nvim"] = {
    config = { "\27LJ\2\n’\5\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\b\0005\3\3\0005\4\4\0=\4\5\0035\4\6\0=\4\a\3=\3\t\2B\0\2\1K\0\1\0\fkeymaps\1\0\0\tn [c\1\2\1\0@&diff ? '[h' : '<cmd>lua require\"gitsigns\".prev_hunk()<CR>'\texpr\2\tn ]c\1\2\1\0@&diff ? ']h' : '<cmd>lua require\"gitsigns\".next_hunk()<CR>'\texpr\2\1\0\n\18n <leader>ghu5<cmd>lua require\"gitsigns\".undo_stage_hunk()<CR>\vbuffer\2\18n <leader>ghs0<cmd>lua require\"gitsigns\".stage_hunk()<CR>\17n <leader>gb4<cmd>lua require\"gitsigns\".blame_line(true)<CR>\tx ih2:<C-U>lua require\"gitsigns\".select_hunk()<CR>\to ih2:<C-U>lua require\"gitsigns\".select_hunk()<CR>\fnoremap\2\18n <leader>ghp2<cmd>lua require\"gitsigns\".preview_hunk()<CR>\18n <leader>ghR2<cmd>lua require\"gitsigns\".reset_buffer()<CR>\18n <leader>ghr0<cmd>lua require\"gitsigns\".reset_hunk()<CR>\nsetup\rgitsigns\frequire\0" },
    loaded = true,
